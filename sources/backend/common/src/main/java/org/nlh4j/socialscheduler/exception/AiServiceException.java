...
public class AiServiceException extends RuntimeException {
     ...
     */
    public AiServiceException(String message, Platform platform, Throwable cause, HttpStatus httpStatus) {
        super(message, cause);
     ...
     * Constructs a new AiServiceException with the specified details.
     * 
     * @param errorCode the error code associated with this exception (should be "AI_SERVICE_UNAVAILABLE")
     * @param message   the detail message
     * @param platform  the platform for which the AI service failed (can be null)
     * @param cause     the original cause of the exception
     */
    public AiServiceException(String errorCode, String message, Platform platform, Throwable cause) {
        super(message, cause);
