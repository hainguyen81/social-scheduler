...
public class RateLimitExceededException extends RuntimeException {
     ...
     */
    public RateLimitExceededException(String userId, String endpoint, long retryAfterSeconds) {
     ...
     */
    public RateLimitExceededException(String userId, String endpoint, long retryAfterSeconds, Throwable cause) {
